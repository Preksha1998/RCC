...
void main(){
	int i,gd=DETECT,gm,n=8,n1=8,n2=7,n3=5;
	float ax[]={0.2,0.2,0.1,0.1,0.4,0.4,0.3,0.3};
	float ay[]={0.1,0.3,0.3,0.4,0.4,0.3,0.3,0.1};
	//float bx[]={0.2,0.3,0.2,0.3,0.2,0.1,0.2,0.1};
	//float by[]={0.1,0.1,0.2,0.3,0.4,0.4,0.2,0.2};
	//float cx[]={0.5,0.3,0.4,0.4,0.6,0.6,0.7};
	//float cy[]={0.7,0.5,0.5,0.1,0.1,0.5,0.5};
	//float dx[]={0.1,0.1,0.5,0.9,0.9};
	//float dy[]={0.1,0.6,0.8,0.6,0.1};
	initgraph(&gd,&gm,"c:/tc/bgi");
	initialize();
	new_frame();
	polygon_abs(n,ax,ay);
	//polygon_abs(n1,bx,by);
	//polygon_abs(n2,cx,cy);
	//polygon_abs(n3,dx,dy);
